...
export default function MakeBook({ route, navigation }) {
  const GPT_API_KEY = 'sk-jurCZiUvy7Qe********3BlbkFJ9A4bC8xq9aoIxh2mHCYy'; // GPT API 키
  const IMAGES_API_KEY = 'sk-jurCZiUvy7Qe********3BlbkFJ9A4bC8xq9aoIxh2mHCYy'; // OpenAI 이미지 API 키
  ...
  return (
    <View style={styles.container}>
      <KeyboardAwareScrollView style={{ width: '100%', flexDirection: 'column' }}>
        ...
        <TextInput style={styles.InsertBookText}
          placeholder="책에 저장될 글이 입력될 공간입니다."
          placeholderTextColor="#000"
          multiline >{GptText}</TextInput>
